...
import { normalizeItemSets } from './normalize/itemSets.js';
...
async function main(): Promise<void> {
  ...
  log.done(`item sets: ${totalItemSets} sets across ${downloaded.length} builds; ${totalItemSetItems} item links`);
