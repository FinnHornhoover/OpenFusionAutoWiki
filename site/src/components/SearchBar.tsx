        ...
        <div className="search-dialog-results" role="listbox">
          ...
          {!q.trim() && (
            <div className="search-empty muted">
              Type to search across missions, NPCs, items, monsters, areas, and nanos.
            </div>
          )}
          {results.map((r, i) => (
            <button
            ...
            >
              {r.icon
                ? <Icon src={r.icon} alt="" size={24} />
                : <span className="icon icon-empty" aria-hidden style={{ width: 24, height: 24 }} />}
